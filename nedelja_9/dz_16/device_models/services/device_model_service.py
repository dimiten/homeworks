...
class DeviceModelsService:
    ...
    @staticmethod
    def get_all_beverages_ids_for_device_model(device_model_id: int):
        my_cursor = mydb.cursor()
        device_model_produces_beverage_repository = DeviceModelProducesBeverageRepository(my_cursor=my_cursor)
        existing_beverage_ids_for_device_model = device_model_produces_beverage_repository.get_all_beverages_ids_for_device_model(
            device_model_id)
        my_cursor.close()
        return existing_beverage_ids_for_device_model
    ...
    def add_new_beverage_to_device_model(device_model_id: int, beverage_id: int):
        my_cursor = mydb.cursor()
        device_model_produces_beverage_repository = DeviceModelProducesBeverageRepository(my_cursor=my_cursor)
        result = device_model_produces_beverage_repository.add_new_beverage_for_device_model(device_model_id, beverage_id)
        my_cursor.close()
        return result
    ...
    def delete_beverage_from_device_model(device_model_id: int, beverage_id: int):
        my_cursor = mydb.cursor()
        device_models_repository = DeviceModelProducesBeverageRepository(my_cursor=my_cursor)
        result = device_models_repository.delete_beverage_from_device_model(device_model_id, beverage_id)
        my_cursor.close()
        return result
